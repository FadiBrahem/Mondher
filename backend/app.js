...
const verifiedClientOrderRoutes = require('./routes/verifiedClientOrder');
const pickedUpOrdersRoutes = require('./routes/pickedUpOrders');



mongoose.connect('mongodb+srv://fedibrahem:neourban123@cluster0.ehj7z.mongodb.net/Vcity',{useNewUrlParser: true , useUnifiedTopology: true})
  .then(()=>{
    console.log('connected to Digimonbase!');
  })
  .catch(()=>{
...
app.use("/api/clientOrder",clientOrderRoutes);
app.use("/api/verifiedClientOrder",verifiedClientOrderRoutes);
