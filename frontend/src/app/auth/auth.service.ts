...
export class AuthService{
  ...
  createUser(name: string , contact: string , email: string ,password: string , role : string){
    const authData  = {name:name , contact:contact , email:email , password:password , role:role};
  ...
  getUserDatas(id: string){
    return this.http.get<{_id: string , name: string, email: string, contact: string, password: string, role: string}>
  ...
  updateUser(id: string ,  name: string, email: string, nic: string, contact: string, password: string, role: string){
    const user  ={id:id , name:name , email:email ,  contact:contact , password:password ,role:role};
    this.http
